...
<style>
  .reserve-box {
    @apply w-56 h-44 border-2 border-blue-400 rounded-2xl bg-white items-center;
  }

  .location-info {
    @apply flex flex-col w-2/5 h-40 bg-gray-300 rounded-2xl ml-2 text-center justify-center items-center;
  }
